...
Reemplaza la planilla de Drive como fuente de verdad. Es la condición para todo lo demás.

## Reglas de negocio

- El profesional no puede ver ni modificar turnos de otros profesionales
- Un profesional puede atender en dos sedes el mismo día si no hay superposición

## Dependencias

Ninguna. Es la primera feature de desarrollo del release.

## Riesgos

| Riesgo | Impacto | Mitigación |
|---|---|---|
| La migración desde la planilla trae datos sucios | Medio | Definir el proceso de carga inicial antes de salir a producción |
